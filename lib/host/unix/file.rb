module Unix::File
  ...
  # TODO: a little of this could potentially be refactored out into a common base module for Files (as opposed to having
  # a separate version of everything for Windows/Linux)
  @base_tmp_dir = nil;
  ...
  def tmpdir(name, options = {})
    ...
    dir = execute("mktemp -td #{name}.XXXXXX")
